<div class="cm-description">
  ...
  <span class="cm-modified"><?php echo $updated; ?></span>
</div>
  ...
  <table class="cm-table">
    ...
    <tbody>
      <tr>
        ...
        <td id="total_cinema"><?php echo $data['cinema']['real']; ?></td>
      ...
      <tr>
            ...
            <table class="cm-meio-interna">
              <tbody>
                ...
                <tr>
                  ...
                  <td style="font-size:12px;" id="total_audio"><?php echo $data['internet']['meios']['audio']['real']; ?></td>
                ...
                <tr>
                  ...
                  <td style="font-size:12px;border-right-color: transparent;">R$</td>
                  <td style="font-size:12px;" id="total_busca"><?php echo $data['internet']['meios']['busca']['real']; ?></td>
                  <td style="font-size:12px;text-align: left;border-right-color: transparent;">$</td>
                ...
                <tr>
                  ...
                  <td style="font-size:12px;border-right-color: transparent;">R$</td>
                  <td style="font-size:12px;" id="total_outros"><?php echo $data['internet']['meios']['outros']['real']; ?></td>
                  <td style="font-size:12px;text-align: left;border-right-color: transparent;">$</td>
                ...
                <tr>
                  ...
                  <td style="font-size:12px;border-right-color: transparent;">R$</td>
                  <td style="font-size:12px;" id="total_social"><?php echo $data['internet']['meios']['social']['real']; ?></td>
                  <td style="font-size:12px;text-align: left;border-right-color: transparent;">$</td>
                ...
                <tr>
                  ...
                  <td style="font-size:12px;border-right-color: transparent;">R$</td>
                  <td style="font-size:12px;" id="total_video"><?php echo $data['internet']['meios']['video']['real']; ?></td>
                  <td style="font-size:12px;text-align: left;border-right-color: transparent;">$</td>
        ...
        <td style="border-right-color: transparent;">R$</td>
        <td id="total_internet"><?php echo $data['internet']['real']; ?></td>
        <td style="border-right-color:transparent;text-align: left;">$</td>
      ...
      <tr>
        ...
        <td style="border-right-color: transparent;">R$</td>
        <td id="total_ext"><?php echo $data['midia_exterior']['real']; ?></td>
        <td style="border-right-color:transparent;text-align: left;">$</td>
      ...
      <tr>
        ...
        <td style="border-right-color: transparent;">R$</td>
        <td id="total_radio"><?php echo $data['radio']['real']; ?></td>
        <td style="border-right-color:transparent;text-align: left;">$</td>
      ...
      <tr>
        ...
        <td style="border-right-color: transparent;">R$</td>
        <td id="total_aberta"><?php echo $data['tv_aberta']['real']; ?></td>
        <td style="border-right-color:transparent;text-align: left;">$</td>
    ...
    <tfoot>
      <tr>
        <td>Total</td>
        <td style="border-right-color: transparent;">R$</td>
        <td id="total_geral"><?php echo $data['total']['real']; ?></td>
