...
namespace Cenp_Meios;

/**
 *  Cenp Meios - Post Type
 * 
...
/**
 * Classe responsável por registrar um novo post type.
 * 
 * @since 1.0.0
 */
class Cenp_Meios_PostType
{
    /**
     * Os nomes dos posts types que serão criados.
     * @var array
     */
    public $names;

    /**
     * Nome do post type que será criado.
     * @var string
     */
    public $name;

    /**
     * Nome no singular do post type.
     * @var string
     */
    public $singular;

    /**
     * Nome no plural do post type.
     * @var string
     */
    public $plural;
    ...
    /**
     * Labels dos posts types.
     * @var array
     */
    public $labels;

    /**
     * Taxonomias dos posts types.
     * @var array
     */
    public $taxonomies = [];

    /**
     * Filtros dos posts types.
     * @var mixed
     */
    public $filters;
    ...
    /**
     * Cria o post type
     * @param mixed $names      Uma string para o nome ou uma matriz de nomes
     * @param array $options    Array de opções do post type criado.
     */
    public function __construct($names, $options = [], $labels = [])
    {
        // Atribui os nomes ao post type
        $this->names($names);

        // Atribui as opções ao post type
        $this->options($options);

        // Atribui as labels ao post type
        $this->labels($labels);
    }
    ...
    public function columns()
    {
        if (!isset($this->columns)) {
            $this->columns = new Cenp_Meios_Columns;
        }
