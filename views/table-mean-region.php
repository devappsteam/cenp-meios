<div class="cm-section cm-section--white">
  <div class="cm-container">
    <div class="cm-description">
      <h4 class="cm-center cm-uppercase"><?php echo $post_meta['cm_description']; ?> por meios e regiões<sup>[SOURCE_MEIOS_REGIOES]</sup></h4>
    </div>
    <div class="cm-table-responsive">
      <table class="cm-table" style="font-size:10px">
        <thead>
          ...
          <tr>
            <th>MEIOS</th>
            <th>Valor Faturado<sup><?php echo $post_meta['cm_source_real']; ?></sup><br>(000)</th>
            <th style="background:#00936c;vertical-align: middle;">USD<sup><?php echo $post_meta['cm_source_dollar']; ?></sup> (000)</th>
            <th>Share (%)</th>
            <th>Valor Faturado<sup><?php echo $post_meta['cm_source_real']; ?></sup><br>(000)</th>
            <th style="background:#00936c;vertical-align: middle;">USD<sup><?php echo $post_meta['cm_source_dollar']; ?></sup> (000)</th>
            <th>Share (%)</th>
